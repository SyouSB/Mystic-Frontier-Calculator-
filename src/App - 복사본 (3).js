...
const App = () => {
  ...
  const loadTemplates = async () => {
    ...
    const diceFiles = [
      ...
      { id: 'S_+_Common', path: './dice/blessed_gray_dice.png' },
      { id: 'S_+_Rare', path: './dice/blessed_blue_dice.png' },
      { id: 'S_+_Epic', path: './dice/blessed_purple_dice.png' },
      { id: 'S_+_Unique', path: './dice/blessed_orange_dice.png' },
      { id: 'S_+_Legendry', path: './dice/blessed_green_dice.png' },

      { id: 'S_+x_Common', path: './dice/gray_holy_rollers.png' }, { id: 'S_+x_Common', path: 'gray_holy_rollers.png' },
      { id: 'S_+x_Rare', path: './dice/blue_holy_rollers.png' },
      { id: 'S_+x_Epic', path: './dice/purple_holy_rollers.png' },
      { id: 'S_+x_Unique', path: './dice/orange_holy_rollers.png' },
      { id: 'S_+x_Legendry', path: './dice/green_holy_rollers.png' },

      { id: 'S_-x_Common', path: './dice/sharp_edged_gray_dice.png' }, { id: 'S_-x_Common', path: 'sharp_edged_gray_dice.png' },
      { id: 'S_-x_Rare', path: './dice/sharp_edged_blue_dice.png' },
      { id: 'S_-x_Epic', path: './dice/sharp_edged_purple_dice.png' },
      { id: 'S_-x_Unique', path: './dice/sharp_edged_orange_dice.png' },
      { id: 'S_-x_Legendry', path: './dice/sharp_edged_green_dice.png' },

      { id: 'S_x_Common', path: './dice/swift_rolling_gray_dice.png' }, { id: 'S_x_Common', path: 'swift_rolling_gray_dice.png' },
      { id: 'S_x_Rare', path: './dice/swift_rolling_blue_dice.png' },
      { id: 'S_x_Epic', path: './dice/swift_rolling_purple_dice.png' },
      { id: 'S_x_Unique', path: './dice/swift_rolling_orange_dice.png' },
      { id: 'S_x_Legendry', path: './dice/swift_rolling_green_dice.png' },
    ];
            ...
            <div className="list-group">
              {analysisResult.siteDetails.length > 0 ? analysisResult.siteDetails.map((s, i) => (
                <div key={i} className="list-item item-site">
                  <div>
                    <strong>{s.id}</strong>
                    <div style={{ fontSize: '10px', color: '#888' }}>RGB: ({s.r}, {s.g}, {s.b})</div>
                  </div>
                </div>
